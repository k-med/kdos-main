...
reading_time: 6
summary: >
  Acids and bases are two types of corrosive substances that react with each other to form salts. Their behavior is fundamental to many chemical and biological processes.
ai_generated: true
...
## Core Idea
**pH Scale:** A logarithmic scale measuring acidity. pH 7 is neutral. pH < 7 is acidic. pH > 7 is basic (alkaline).
$$ \text{pH} = -\log[H^+] $$
