...
reading_time: 6
summary: >
  Electrochemistry studies the relationship between electricity and chemical change. It deals with the movement of electrons between chemical species.
ai_generated: true
...
**Galvanic Cell (Voltaic Cell):** A device that converts chemical energy into electrical energy (spontaneous).
