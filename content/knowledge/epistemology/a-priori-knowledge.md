...
reading_time: 7
summary: >
  A priori knowledge is knowledge that is independent of all particular experiences, as opposed to a posteriori knowledge, which derives from experience.
ai_generated: true
...
- **Synthetic:** True by experience ("The cat is on the mat").
Kant asked: Is there "Synthetic A Priori" knowledge? (Knowledge about the world that we know without looking?).

## Formal Definition (if applicable)
**Necessary Truth:** A statement that *must* be true in all possible worlds ($2+2=4$).
**Contingent Truth:** A statement that happens to be true but could have been false (The sky is blue).
