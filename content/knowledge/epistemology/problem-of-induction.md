...
## Core Idea
**Induction:** Reasoning from specific observations to general rules. (I saw 100 white swans -> All swans are white).
**The Problem:** You can't justify induction using logic (it's not a logical contradiction that the sun won't rise). You can't justify it using experience (that's circular: "Induction worked in the past, so it will work in the future" *is* induction).
