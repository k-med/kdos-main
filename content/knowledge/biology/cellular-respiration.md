...
reading_time: 6
summary: >
  Cellular respiration is the metabolic process by which cells break down glucose to produce ATP, the universal energy currency of life. It occurs in the mitochondria of eukaryotic cells.
ai_generated: true
...
## Core Idea
The overall equation is the reverse of photosynthesis:
$$ C_6H_{12}O_6 + 6O_2 \rightarrow 6CO_2 + 6H_2O + \text{ATP} $$

## Formal Definition (if applicable)
The process has three main stages:
1.  **Glycolysis:** Breaking glucose into pyruvate (in cytoplasm).
2.  **Krebs Cycle (Citric Acid Cycle):** Breaking down pyruvate to release electrons (in mitochondria).
3.  **Oxidative Phosphorylation:** Using electrons to power the Electron Transport Chain and generate ATP.
