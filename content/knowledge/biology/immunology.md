...
reading_time: 7
summary: >
  Immunology is the study of the immune system, a complex network of cells and proteins that defends the body against infection. It covers the distinction between self and non-self.
ai_generated: true
...
**Innate Immunity:** The non-specific, immediate defense (e.g., skin, inflammation).
**Adaptive Immunity:** The specific, learned defense (e.g., antibodies, T-cells) that has memory.
